...
public class ModItems {
    ...
    public static final RegistryObject<Item> BEEF_BURGER = ITEMS.register("beef_burger",
            () -> new Item(new Item.Properties().m_41491_(BurgerMod.TAB_BURGERMOD).m_41489_(ModFood.BURGER_TIER_1)));
    ...
    public static final RegistryObject<Item> MUTTON_BURGER = ITEMS.register("mutton_burger",
            () -> new Item(new Item.Properties().m_41491_(BurgerMod.TAB_BURGERMOD).m_41489_(ModFood.BURGER_TIER_2)));
    public static final RegistryObject<Item> CHICKEN_BURGER = ITEMS.register("chicken_burger",
            () -> new Item(new Item.Properties().m_41491_(BurgerMod.TAB_BURGERMOD).m_41489_(ModFood.BURGER_TIER_3)));

    // Fish + Egg Burgers
    public static final RegistryObject<Item> SALMON_BURGER = ITEMS.register("salmon_burger",
            () -> new Item(new Item.Properties().m_41491_(BurgerMod.TAB_BURGERMOD).m_41489_(ModFood.BURGER_TIER_4)));
    public static final RegistryObject<Item> COD_BURGER = ITEMS.register("cod_burger",
            () -> new Item(new Item.Properties().m_41491_(BurgerMod.TAB_BURGERMOD).m_41489_(ModFood.BURGER_TIER_5)));
    ...
    public static final RegistryObject<Item> GOLDEN_BEEF_BURGER = ITEMS.register("golden_beef_burger",
            () -> new Item(new Item.Properties().m_41491_(BurgerMod.TAB_BURGERMOD).m_41489_(ModFood.GOLDEN_BURGER_TIER_1)));
    ...
    public static final RegistryObject<Item> GOLDEN_MUTTON_BURGER = ITEMS.register("golden_mutton_burger",
            () -> new Item(new Item.Properties().m_41491_(BurgerMod.TAB_BURGERMOD).m_41489_(ModFood.GOLDEN_BURGER_TIER_2)));
    public static final RegistryObject<Item> GOLDEN_CHICKEN_BURGER = ITEMS.register("golden_chicken_burger",
            () -> new Item(new Item.Properties().m_41491_(BurgerMod.TAB_BURGERMOD).m_41489_(ModFood.GOLDEN_BURGER_TIER_3)));
    ...
    public static final RegistryObject<Item> GOLDEN_COD_BURGER = ITEMS.register("golden_cod_burger",
            () -> new Item(new Item.Properties().m_41491_(BurgerMod.TAB_BURGERMOD).m_41489_(ModFood.GOLDEN_BURGER_TIER_4)));

    // Eggs
    public static final RegistryObject<Item> SCRAMBLED_EGG = ITEMS.register("scrambled_egg",
            () -> new Item(new Item.Properties().m_41491_(BurgerMod.TAB_BURGERMOD).m_41489_(ModFood.RAW_EGG_FOOD)));
    public static final RegistryObject<Item> FRIED_SCRAMBLED_EGG = ITEMS.register("fried_scrambled_egg",
            () -> new Item(new Item.Properties().m_41491_(BurgerMod.TAB_BURGERMOD).m_41489_(ModFood.FRIED_EGG_FOOD)));

    // Champignons
    public static final RegistryObject<Item> RAW_CHAMPIGNONS = ITEMS.register("raw_champignons",
            () -> new Item(new Item.Properties().m_41491_(BurgerMod.TAB_BURGERMOD).m_41489_(ModFood.RAW_CHAMPIGNONS_FOOD)));
    public static final RegistryObject<Item> COOKED_CHAMPIGNONS = ITEMS.register("cooked_champignons",
            () -> new Item(new Item.Properties().m_41491_(BurgerMod.TAB_BURGERMOD).m_41489_(ModFood.INGREDIENT_FOOD)));

    // Others
    public static final RegistryObject<Item> CHEESE = ITEMS.register("cheese",
            () -> new Item(new Item.Properties().m_41491_(BurgerMod.TAB_BURGERMOD).m_41489_(ModFood.INGREDIENT_FOOD)));
    public static final RegistryObject<Item> COOKED_CHICKEN_NUGGET = ITEMS.register("cooked_chicken_nugget",
            () -> new Item(new Item.Properties().m_41491_(BurgerMod.TAB_BURGERMOD).m_41489_(ModFood.NUGGET_FOOD)));
    public static final RegistryObject<Item> FRIES = ITEMS.register("fries",
            () -> new Item(new Item.Properties().m_41491_(BurgerMod.TAB_BURGERMOD).m_41489_(ModFood.FRIES_FOOD)));
}