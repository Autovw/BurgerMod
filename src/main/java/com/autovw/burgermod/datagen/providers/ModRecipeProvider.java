...
public class ModRecipeProvider extends RecipeProvider {
     ...
     */
    public static void baseBurgerRecipe(Consumer<IFinishedRecipe> recipeConsumer, IItemProvider result, int resultAmount, IItemProvider mainIngredient, ITag<Item> extraIngredient) {
     ...
     * @param extraIngredient Extra ingredient, a tag by default (e.g. forge:cheese for a cheese burger)
     */
    public static void baseBurgerRecipe(Consumer<IFinishedRecipe> recipeConsumer, IItemProvider result, int resultAmount, ITag<Item> mainIngredient, ITag<Item> extraIngredient) {
        ShapedRecipeBuilder.shaped(result, resultAmount)
                .define('B', ModTags.FORGE_BREAD)
                .define('#', mainIngredient)
                .define('*', extraIngredient)
    ...
    public static void eggBurgerRecipe(Consumer<IFinishedRecipe> recipeConsumer, IItemProvider result, IItemProvider ingredient) {
        baseBurgerRecipe(recipeConsumer, result, 2, ingredient, ModTags.FORGE_FRIED_EGG);
    }

    public static void eggBurgerRecipe(Consumer<IFinishedRecipe> recipeConsumer, IItemProvider result, Tag<Item> ingredient) {
        baseBurgerRecipe(recipeConsumer, result, 2, ingredient, ModTags.FORGE_FRIED_EGG);
    }

    public static void cheeseBurgerRecipe(Consumer<IFinishedRecipe> recipeConsumer, IItemProvider result, IItemProvider ingredient) {
        baseBurgerRecipe(recipeConsumer, result, 2, ingredient, ModTags.FORGE_CHEESE);
    }

    public static void cheeseBurgerRecipe(Consumer<IFinishedRecipe> recipeConsumer, IItemProvider result, Tag<Item> ingredient) {
        baseBurgerRecipe(recipeConsumer, result, 2, ingredient, ModTags.FORGE_CHEESE);
    }

    public static void champignonBurgerRecipe(Consumer<IFinishedRecipe> recipeConsumer, IItemProvider result, IItemProvider ingredient) {
        baseBurgerRecipe(recipeConsumer, result, 2, ingredient, ModTags.FORGE_COOKED_MUSHROOM);
    }

    public static void champignonBurgerRecipe(Consumer<IFinishedRecipe> recipeConsumer, IItemProvider result, Tag<Item> ingredient) {
        baseBurgerRecipe(recipeConsumer, result, 2, ingredient, ModTags.FORGE_COOKED_MUSHROOM);
    }
     ...
     */
    public static void goldenBurgerRecipe(Consumer<IFinishedRecipe> recipeConsumer, IItemProvider result, ITag<Item> ingredient) {
     ...
     */
    public static void baseFoodCookingRecipe(Consumer<IFinishedRecipe> recipeConsumer, IItemProvider result, IItemProvider ingredient, float experience, String modId) {
        ...
        CookingRecipeBuilder.cooking(Ingredient.of(ingredient), result, experience, 600, IRecipeSerializer.CAMPFIRE_COOKING_RECIPE)
                .unlockedBy("has_" + ingredient.toString(), has(ingredient))
                .save(recipeConsumer, new ResourceLocation(modId, result + "_from_campfire"));

        CookingRecipeBuilder.cooking(Ingredient.of(ingredient), result, experience, 100, IRecipeSerializer.SMOKING_RECIPE)
                .unlockedBy("has_" + ingredient.toString(), has(ingredient))
                .save(recipeConsumer, new ResourceLocation(modId, result + "_from_smoker"));
    }

    private static void cookingRecipe(Consumer<IFinishedRecipe> recipeConsumer, IItemProvider result, IItemProvider ingredient) {
        baseFoodCookingRecipe(recipeConsumer, result, ingredient, 0.25F, BurgerMod.MOD_ID);
    }

    private static void scrambledEggRecipe(Consumer<IFinishedRecipe> recipeConsumer, IItemProvider result) {
    ...
    private static void cheeseRecipe(Consumer<IFinishedRecipe> recipeConsumer, IItemProvider result) {
        internalCheeseRecipe(recipeConsumer, result, Items.MILK_BUCKET, Items.SUGAR);
    }

    private static void internalCheeseRecipe(Consumer<IFinishedRecipe> recipeConsumer, IItemProvider result, IItemProvider ingredient1, IItemProvider ingredient2) {
    ...
    private static void rawChampignonRecipe(Consumer<IFinishedRecipe> recipeConsumer, IItemProvider result) {
        ShapelessRecipeBuilder.shapeless(result)
    ...
    private static void chickenNuggetRecipe(Consumer<IFinishedRecipe> recipeConsumer) {
    ...
    private static void friesRecipe(Consumer<IFinishedRecipe> recipeConsumer) {
    ...
    private static void hotdogRecipe(Consumer<IFinishedRecipe> recipeConsumer) {
    ...
    private static void sweetBerryTartRecipe(Consumer<IFinishedRecipe> recipeConsumer) {
