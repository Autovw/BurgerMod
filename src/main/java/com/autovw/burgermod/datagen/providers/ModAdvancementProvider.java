...
public class ModAdvancementProvider extends AdvancementProvider {
    ...
    protected void registerAdvancements(Consumer<Advancement> consumer, ExistingFileHelper fileHelper) {
        Advancement craft_burger = Advancement.Builder.advancement()
                ...
                .display(ModItems.BEEF_BURGER.get(), new TranslatableComponent("advancements.burgermod.husbandry.craft_burger.title"), new TranslatableComponent("advancements.burgermod.husbandry.craft_burger.description"), null, FrameType.TASK, true, true, false)
        ...
        Advancement.Builder.advancement()
                .parent(craft_burger)
                .display(ModItems.GOLDEN_BEEF_BURGER.get(), new TranslatableComponent("advancements.burgermod.husbandry.craft_golden_burger.title"), new TranslatableComponent("advancements.burgermod.husbandry.craft_golden_burger.description"), null, FrameType.CHALLENGE, true, true, false)
