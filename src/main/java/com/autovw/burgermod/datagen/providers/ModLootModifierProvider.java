...
public class ModLootModifierProvider extends GlobalLootModifierProvider {
    ...
    protected void start() {
        ...
        addRangedChance(ModLootModifiers.BASTION_TREASURE_ENCHANTED_GOLDEN_BURGER_ADDITION.get(), new ResourceLocation("chests/bastion_treasure"), ModItems.ENCHANTED_GOLDEN_BURGER.get(), 0, 1, 0.15f);
    }
