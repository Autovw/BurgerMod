...
public final class ModConsumables
{
    ...
    public static final Consumable ENCHANTED_GOLDEN_BURGER = Consumables.defaultFood().onConsume(new ApplyStatusEffectsConsumeEffect(List.of(ModEffects.GOLDEN_BURGER_REGENERATION, ModEffects.ENCHANTED_GOLDEN_BURGER_DAMAGE_RESISTANCE, ModEffects.ENCHANTED_GOLDEN_BURGER_FIRE_RESISTANCE, ModEffects.ENCHANTED_GOLDEN_BURGER_ABSORPTION))).build();
}
